...
public class NotVisitedTwiceHandler:IRequestHandler<NotVisitedTwiceRequest, VisitedTwiceResponse>
{
    private readonly ApplicationDbContext _db;
    public NotVisitedTwiceHandler(ApplicationDbContext db)
    {
        _db = db;
    }
    
    public async Task<VisitedTwiceResponse> Handle(NotVisitedTwiceRequest request, CancellationToken cancellationToken)
    {
